...
public static class Injection
{
    ...
    public static IServiceCollection AddUserAnisongDBClients(this IServiceCollection services)
    {
        services.AddScoped<AnisongDBClient>();
        services.AddScoped<IAnisongDBClient>(sp => sp.GetRequiredService<AnisongDBClient>());

        services.AddHttpClient(ExternalClientType.AnisongDB.ToString())
            .ConfigureHttpClient((sp, c) =>
            {
                c.BaseAddress = new Uri("https://anisongdb.com/");
            })
